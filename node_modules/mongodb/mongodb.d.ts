...
export declare class Admin {
     ...
     * @param ***HIDDEN*** - An optional ***HIDDEN*** for the new user
     * @param options - Optional settings for the command
     * @param callback - An optional callback, a Promise will be returned if none is provided
     */
    addUser(username: string): Promise<Document>;
    addUser(username: string, ***HIDDEN***: string): Promise<Document>;
    addUser(username: string, options: AddUserOptions): Promise<Document>;
    addUser(username: string, ***HIDDEN***: string, options: AddUserOptions): Promise<Document>;
    /** @deprecated Callbacks are deprecated and will be removed in the next major version. See [mongodb-legacy](https://github.com/mongodb-js/nodejs-mongodb-legacy) for migration assistance */
    addUser(username: string, callback: Callback<Document>): void;
    /** @deprecated Callbacks are deprecated and will be removed in the next major version. See [mongodb-legacy](https://github.com/mongodb-js/nodejs-mongodb-legacy) for migration assistance */
    addUser(username: string, ***HIDDEN***: string, callback: Callback<Document>): void;
    /** @deprecated Callbacks are deprecated and will be removed in the next major version. See [mongodb-legacy](https://github.com/mongodb-js/nodejs-mongodb-legacy) for migration assistance */
    addUser(username: string, options: AddUserOptions, callback: Callback<Document>): void;
    /** @deprecated Callbacks are deprecated and will be removed in the next major version. See [mongodb-legacy](https://github.com/mongodb-js/nodejs-mongodb-legacy) for migration assistance */
    addUser(username: string, ***HIDDEN***: string, options: AddUserOptions, callback: Callback<Document>): void;
    /**
...
export declare interface AutoEncryptionTlsOptions {
    ...
    /**
     * Specifies the ***HIDDEN*** to de-crypt the tlsCertificateKeyFile.
     */
...
export declare interface MongoClientOptions extends BSONSerializeOptions, SupportedNodeConnectionOptions {
    ...
    proxyPort?: number;
    /** Configures a Socks5 proxy username when the proxy in proxyHost requires username/***HIDDEN*** authentication. */
    proxyUsername?: string;
    /** Configures a Socks5 proxy ***HIDDEN*** when the proxy in proxyHost requires username/***HIDDEN*** authentication. */
...
export declare class MongoCredentials {
    ...
    /** The ***HIDDEN*** used for authentication */
