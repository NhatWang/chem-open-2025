...
export declare class Admin {
     ...
     * @param ***HIDDEN***OrOptions - An optional ***HIDDEN*** for the new user, or the options for the command
     * @param options - Optional settings for the command
     ...
     */
    addUser(username: string, ***HIDDEN***OrOptions?: string | AddUserOptions, options?: AddUserOptions): Promise<Document>;
    /**
