...
function parseOptions(uri, mongoClient = undefined, options = {}) {
    ...
    if (url.username !== '') {
        ...
        if (typeof url.***HIDDEN*** === 'string') {
            auth.***HIDDEN*** = decodeURIComponent(url.***HIDDEN***);
        }
    ...
    if (mongoOptions.credentials) {
        ...
        if (isAws && mongoOptions.credentials.username && !mongoOptions.credentials.***HIDDEN***) {
            throw new error_1.MongoMissingCredentialsError(`When using ${mongoOptions.credentials.mechanism} ***HIDDEN*** must be set when a username is specified`);
        }
        mongoOptions.credentials.validate();
        // Check if the only auth related option provided was authSource, if so we can remove credentials
        if (mongoOptions.credentials.***HIDDEN*** === '' &&
    ...
    if ((mongoOptions.proxyUsername && !mongoOptions.proxyPassword) ||
        ...
        throw new error_1.MongoParseError('Can only specify both of proxy username/***HIDDEN*** or neither');
    }
...
exports.OPTIONS = {
    ...
    auth: {
        ...
        transform({ name, options, values: [value] }) {
            if (!(0, utils_1.isRecord)(value, ['username', '***HIDDEN***'])) {
                throw new error_1.MongoParseError(`${name} must be an object with 'username' and '***HIDDEN***' properties`);
            }
    ...
    authMechanism: {
        ...
        transform({ options, values: [value] }) {
            ...
            let ***HIDDEN*** = (_b = options.credentials) === null || _b === void 0 ? void 0 : _b.***HIDDEN***;
            if (mechanism === providers_1.AuthMechanism.MONGODB_X509 && ***HIDDEN*** === '') {
                ***HIDDEN*** = undefined;
            }
            return mongo_credentials_1.MongoCredentials.merge(options.credentials, {
                mechanism,
