...
function continueScramConversation(cryptoMethod, response, authContext, callback) {
    ...
    if (cryptoMethod === 'sha256') {
        processedPassword =
            'kModuleError' in deps_1.saslprep || typeof deps_1.saslprep !== 'function' ? ***HIDDEN*** : (0, deps_1.saslprep)(***HIDDEN***);
    }
    else {
        try {
            processedPassword = ***HIDDEN***Digest(username, ***HIDDEN***);
        }
        catch (e) {
            return callback(e);
        }
...
function ***HIDDEN***Digest(username, ***HIDDEN***) {
    ...
    md5.update(`${username}:mongo:${***HIDDEN***}`, 'utf8');
