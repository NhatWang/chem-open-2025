...
class Db {
     ...
     */
    async addUser(username, ***HIDDEN***OrOptions, options) {
        options =
            options != null && typeof options === 'object'
                ? options
                : ***HIDDEN***OrOptions != null && typeof ***HIDDEN***OrOptions === 'object'
                    ? ***HIDDEN***OrOptions
                    : undefined;
        const ***HIDDEN*** = typeof ***HIDDEN***OrOptions === 'string' ? ***HIDDEN***OrOptions : undefined;
        return (0, execute_operation_1.executeOperation)(this.client, new add_user_1.AddUserOperation(this, username, ***HIDDEN***, (0, utils_1.resolveOptions)(this, options)));
    }
    /**
