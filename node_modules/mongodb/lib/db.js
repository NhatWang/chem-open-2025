...
class Db {
    ...
    addUser(username, ***HIDDEN***, options, callback) {
        ...
        return (0, execute_operation_1.executeOperation)(this.s.client, new add_user_1.AddUserOperation(this, username, ***HIDDEN***, (0, utils_1.resolveOptions)(this, options)), callback);
    }
