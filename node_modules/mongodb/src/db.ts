...
export class Db {
  ...
  addUser(
    username: string,
    ***HIDDEN***?: string | AddUserOptions | Callback<Document>,
    options?: AddUserOptions | Callback<Document>,
    callback?: Callback<Document>
  ): Promise<Document> | void {
    if (typeof ***HIDDEN*** === 'function') {
      (callback = ***HIDDEN***), (***HIDDEN*** = undefined), (options = {});
    } else if (typeof ***HIDDEN*** !== 'string') {
      if (typeof options === 'function') {
        (callback = options), (options = ***HIDDEN***), (***HIDDEN*** = undefined);
      } else {
        (options = ***HIDDEN***), (callback = undefined), (***HIDDEN*** = undefined);
      }
    } else {
      if (typeof options === 'function') (callback = options), (options = {});
    }
    ...
    return executeOperation(
      this.s.client,
      new AddUserOperation(this, username, ***HIDDEN***, resolveOptions(this, options)),
      callback
    );
  }
