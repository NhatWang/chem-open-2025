...
| `socks(v5)`| [socks-proxy-agent][]           | [socks-proxy-agent][]            | `socks://username:***HIDDEN***@some-socks-proxy.com:9050` (username & ***HIDDEN*** are optional)
| `socks5`   | [socks-proxy-agent][]           | [socks-proxy-agent][]            | `socks5://username:***HIDDEN***@some-socks-proxy.com:9050` (username & ***HIDDEN*** are optional)
