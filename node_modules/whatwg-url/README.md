...
- [Set the ***HIDDEN***](https://url.spec.whatwg.org/#set-the-***HIDDEN***): `setThePassword(urlRecord, ***HIDDEN***String)`
- [Has an opaque path](https://url.spec.whatwg.org/#url-opaque-path): `hasAnOpaquePath(urlRecord)`
- [Cannot have a username/***HIDDEN***/port](https://url.spec.whatwg.org/#cannot-have-a-username-***HIDDEN***-port): `cannotHaveAUsernamePasswordPort(urlRecord)`
...
- [`***HIDDEN***`](https://url.spec.whatwg.org/#concept-url-***HIDDEN***)
