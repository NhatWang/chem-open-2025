...
declare module "crypto" {
     ...
     * const ***HIDDEN*** = 'Password used to generate key';
     *
     * // First, we'll generate the key. The key length is dependent on the algorithm.
     * // In this case for aes192, it is 24 bytes (192 bits).
     * scrypt(***HIDDEN***, 'salt', 24, (err, key) => {
     *   if (err) throw err;
     ...
     * const key = scryptSync(***HIDDEN***, 'salt', 24);
     ...
     * applied to derive a key of the requested byte length (`keylen`) from the `***HIDDEN***`, `salt` and `iterations`.
     *
     ...
     *
     * When passing strings for `***HIDDEN***` or `salt`, please consider `caveats when using strings as inputs to cryptographic APIs`.
     *
     * ```js
     * const {
     *   pbkdf2,
    ...
    /**
     * Provides an asynchronous [scrypt](https://en.wikipedia.org/wiki/Scrypt) implementation. Scrypt is a ***HIDDEN***-based
     ...
     * scrypt('***HIDDEN***', 'salt', 64, (err, derivedKey) => {
     *   if (err) throw err;
     *   console.log(derivedKey.toString('hex'));  // '3745e48...08d59ae'
     * });
     * // Using a custom N parameter. Must be a power of two.
     * scrypt('***HIDDEN***', 'salt', 64, { N: 1024 }, (err, derivedKey) => {
     *   if (err) throw err;
    ...
    /**
     * Provides a synchronous [scrypt](https://en.wikipedia.org/wiki/Scrypt) implementation. Scrypt is a ***HIDDEN***-based
     * key derivation function that is designed to be expensive computationally and
     * memory-wise in order to make brute-force attacks unrewarding.
     *
     * The `salt` should be as unique as possible. It is recommended that a salt is
     ...
     * // Using the factory defaults.
     *
     * const key1 = scryptSync('***HIDDEN***', 'salt', 64);
     * console.log(key1.toString('hex'));  // '3745e48...08d59ae'
     * // Using a custom N parameter. Must be a power of two.
     * const key2 = scryptSync('***HIDDEN***', 'salt', 64, { N: 1024 });
     * console.log(key2.toString('hex'));  // '3745e48...aa39b34'
     * ```
     * @since v10.5.0
     */
    function scryptSync(***HIDDEN***: BinaryLike, salt: BinaryLike, keylen: number, options?: ScryptOptions): Buffer;
