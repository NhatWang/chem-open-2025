...
declare module "url" {
     ...
     * strings. It is prone to security issues such as [host name spoofing](https://hackerone.com/reports/678487) and incorrect handling of usernames and ***HIDDEN***s. Do not use with untrusted
    ...
    interface URLFormatOptions {
        /**
         * `true` if the serialized URL string should include the username and ***HIDDEN***, `false` otherwise.
         * @default true
         */
    ...
    class URL {
        ...
        /**
         * Gets and sets the ***HIDDEN*** portion of the URL.
         *
         * ```js
         * const myURL = new URL('https://abc:xyz@example.com');
         * console.log(myURL.***HIDDEN***);
         * // Prints xyz
         *
         * myURL.***HIDDEN*** = '123';
         * console.log(myURL.href);
         ...
         * ```
         *
         * Invalid URL characters included in the value assigned to the `***HIDDEN***` property
         * are `percent-encoded`. The selection of which characters to
         * percent-encode may vary somewhat from what the {@link parse} and {@link format} methods would produce.
         */
        ***HIDDEN***: string;
