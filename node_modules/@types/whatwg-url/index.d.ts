...
/** https://url.spec.whatwg.org/#set-the-***HIDDEN*** */
export function setThePassword(urlRecord: URLRecord, ***HIDDEN***: string): void;

/** https://url.spec.whatwg.org/#cannot-have-a-username-***HIDDEN***-port */
