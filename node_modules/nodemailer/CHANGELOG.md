...
-   Do not show ***HIDDEN***s in SMTP transaction logs. All ***HIDDEN***s used in logging are replaced by `"/* secret */"`
...
-   Set username and ***HIDDEN*** on the connection proxy object correctly (UsamaAshraf) [250b1a8]
