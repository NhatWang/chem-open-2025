...
const HOSTS_REGEX = /^(?<protocol>[^/]+):\/\/(?:(?<username>[^:@]*)(?::(?<***HIDDEN***>[^@]*))?@)?(?<hosts>(?!:)[^/?@]*)(?<rest>.*)/;
...
class ConnectionString extends URLWithoutHost {
    constructor(uri, options = {}) {
        ...
        const { protocol, username, ***HIDDEN***, hosts, rest } = (_a = match.groups) !== null && _a !== void 0 ? _a : {};
        if (!looseValidation) {
            if (!protocol || !hosts) {
            ...
            try {
                ...
                decodeURIComponent(***HIDDEN*** !== null && ***HIDDEN*** !== void 0 ? ***HIDDEN*** : '');
            }
            catch (err) {
            ...
            if (***HIDDEN*** === null || ***HIDDEN*** === void 0 ? void 0 : ***HIDDEN***.match(illegalCharacters)) {
    ...
    [Symbol.for('nodejs.util.inspect.custom')]() {
        const { href, origin, protocol, username, ***HIDDEN***, hosts, pathname, search, searchParams, hash } = this;
        return { href, origin, protocol, username, ***HIDDEN***, hosts, pathname, search, searchParams, hash };
    }
}
