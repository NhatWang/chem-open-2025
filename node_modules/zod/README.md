...
const ***HIDDEN***Form = z
  ...
  .refine((data) => data.***HIDDEN*** === data.confirm, {
    message: "Passwords don't match",
    path: ["confirm"], // path of error
  });

***HIDDEN***Form.parse({ ***HIDDEN***: "asdf", confirm: "qwer" });
```
...
<!-- Note that the `path` is set to `["confirm"]` , so you can easily display this error underneath the "Confirm ***HIDDEN***" textbox.

```ts
const allForms = z.object({ ***HIDDEN***Form }).parse({
  ***HIDDEN***Form: {
    ***HIDDEN***: "asdf",
    confirm: "qwer",
  },
