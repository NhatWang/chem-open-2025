...
class Client {
    ...
    /**
     * Login a user with a ***HIDDEN***.
     *
     * @param user  Username to use for login. Optional, default is "anonymous".
     * @param ***HIDDEN***  Password to use for login. Optional, default is "guest".
     */
    login(user = "anonymous", ***HIDDEN*** = "guest") {
        ...
        return this.ftp.handle("USER " + user, (res, task) => {
            ...
            else if (res.code === 331) { // User name okay, need ***HIDDEN***
                this.ftp.send("PASS " + ***HIDDEN***);
            }
    ...
    async access(options = {}) {
        ...
        // Set UTF-8 on before login in case there are non-ascii characters in user or ***HIDDEN***.
        // Note that this might not work before login depending on server.
        await this.sendIgnoringError("OPTS UTF8 ON");
        await this.login(options.user, options.***HIDDEN***);
