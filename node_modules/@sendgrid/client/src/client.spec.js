...
describe('client', () => {
  ...
  describe('setTwilioEmailAuth', () => {
    it('should not log a warning for proper creds', () => {
      sgClient.setTwilioEmailAuth('username', '***HIDDEN***');
      expect(consoleWarnSpy.notCalled).to.equal(true);
    });

    it('should log a warning for a null ***HIDDEN***', () => {
...
describe('test_user_***HIDDEN***_put', () => {
  const request = {};
  request.body = {
    new_***HIDDEN***: 'new_***HIDDEN***',
    old_***HIDDEN***: 'old_***HIDDEN***',
  };
  request.method = 'PUT';
  request.url = '/v3/user/***HIDDEN***';
  it('should have the correct response code', () => {
    return testRequest(request, 200);
  });
});
