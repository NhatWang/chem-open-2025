...
class Client {
  ...
  setTwilioEmailAuth(username, ***HIDDEN***) {
    const b64Auth = Buffer.from(username + ':' + ***HIDDEN***).toString('base64');
    this.auth = 'Basic ' + b64Auth;
    this.setDefaultRequest('baseUrl', TWILIO_BASE_URL);

    if (!this.isValidTwilioAuth(username, ***HIDDEN***)) {
  ...
  isValidTwilioAuth(username, ***HIDDEN***) {
    return this.isString(username) && username
      && this.isString(***HIDDEN***) && ***HIDDEN***;
  }
