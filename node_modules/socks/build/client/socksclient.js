...
class SocksClient extends events_1.EventEmitter {
    ...
    sendSocks5InitialHandshake() {
        ...
        if (this.options.proxy.userId || this.options.proxy.***HIDDEN***) {
    ...
    handleInitialSocks5HandshakeResponse() {
        ...
        if (data[0] !== 0x05) {
            ...
            if (data[1] === constants_1.Socks5Auth.NoAuth) {
                ...
                // If selected Socks v5 auth method is user/***HIDDEN***, send auth handshake.
            }
    ...
    /**
     * Sends Socks v5 user & ***HIDDEN*** auth handshake.
     *
     * Note: No auth and user/pass are currently supported.
     */
    sendSocks5UserPassAuthentication() {
        const userId = this.options.proxy.userId || '';
        const ***HIDDEN*** = this.options.proxy.***HIDDEN*** || '';
        const buff = new smart_buffer_1.SmartBuffer();
        buff.writeUInt8(0x01);
        buff.writeUInt8(Buffer.byteLength(userId));
        buff.writeString(userId);
        buff.writeUInt8(Buffer.byteLength(***HIDDEN***));
