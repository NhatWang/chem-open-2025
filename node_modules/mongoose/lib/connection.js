...
/**
 * A list of authentication mechanisms that don't require a ***HIDDEN*** for authentication.
...
/**
 * The ***HIDDEN*** specified in the URI
 *
 * #### Example:
 *
 ...
 * @param {String} [options.pass] ***HIDDEN*** for authentication, equivalent to `options.auth.***HIDDEN***`. Maintained for backwards compatibility.
 ...
 * username and ***HIDDEN*** are both provided than authentication is needed, but in some cases a
 ...
 * ***HIDDEN*** to authenticate according to the auth objects passed into the openUri methods.
 *
 * @api private
 * @return {Boolean} true if the authentication mechanism specified in the options object requires
 *  a ***HIDDEN***, otherwise false.
 */
 ...
 * data to authenticate with. Generally this is true if the username and ***HIDDEN*** are both specified
 * but in some authentication methods, a ***HIDDEN*** is not required for authentication so only a username
 * is required.
 *
