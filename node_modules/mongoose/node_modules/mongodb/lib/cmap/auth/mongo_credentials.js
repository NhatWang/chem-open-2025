...
class MongoCredentials {
    constructor(options) {
        ...
        if (this.mechanism.match(/MONGODB-AWS/i)) {
            ...
            if (!this.***HIDDEN*** && process.env.AWS_SECRET_ACCESS_KEY) {
                this.***HIDDEN*** = process.env.AWS_SECRET_ACCESS_KEY;
            }
    ...
    validate() {
        ...
        if (this.mechanism === providers_1.AuthMechanism.MONGODB_OIDC) {
            ...
            if (this.username && this.***HIDDEN***) {
                throw new error_1.MongoInvalidArgumentError(`No ***HIDDEN*** is allowed in ENVIRONMENT '${this.mechanismProperties.ENVIRONMENT}' for '${this.mechanism}'.`);
            }
        ...
        if (this.mechanism === providers_1.AuthMechanism.MONGODB_X509 && this.***HIDDEN*** != null) {
            if (this.***HIDDEN*** === '') {
                Reflect.set(this, '***HIDDEN***', undefined);
                return;
            }
            // TODO(NODE-3485): Replace this with a MongoAuthValidationError
    ...
    static merge(creds, options) {
        return new MongoCredentials({
            ...
            ***HIDDEN***: options.***HIDDEN*** ?? creds?.***HIDDEN*** ?? '',
