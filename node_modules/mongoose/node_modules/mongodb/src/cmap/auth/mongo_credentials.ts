  ...
  validate(): void {
    ...
    if (this.mechanism === AuthMechanism.MONGODB_OIDC) {
      ...
      if (this.username && this.***HIDDEN***) {
        throw new MongoInvalidArgumentError(
          `No ***HIDDEN*** is allowed in ENVIRONMENT '${this.mechanismProperties.ENVIRONMENT}' for '${this.mechanism}'.`
        );
      }
    ...
    if (this.mechanism === AuthMechanism.MONGODB_X509 && this.***HIDDEN*** != null) {
      if (this.***HIDDEN*** === '') {
